...
| **Files** | `docs/decisions/poc/0001-mesh-model-and-topology.md`, `src/logic/io/stl/parseStl.ts`, AGENTS.md |
...
| **Files** | `docs/decisions/poc/0003-unfold-quality-detection.md` (W2), `analyzeUnfoldedIsland.ts` |
