...
| QA | Audit remediation (Slices 0–5; 6–7 backlog) | **In progress** (Slice 0 complete) | [ADR 0004](../decisions/0004-tech-debt-remediation-strategy.md), [archive/qa-audit-remediation.md](archive/qa-audit-remediation.md), [qa-audit.md](../qa-audit.md) |
